...
translations = {
    "Français": {
        ...
        "cognitive_metrics": "Métriques cognitives",
        "mecroyance_index": "Indice de mécroyance (M)",
        "mendacity_index": "Indice de mensonge (ME)",
        "cognitive_gap": "Écart cognitif (M − ME)",
        "dominant_pattern_title": "Structure cognitive dominante",
        "dominant_pattern": "Structure dominante",
        ...
        "explain_hard_fact_low": "Le Hard Fact Score est très faible : le texte contient peu d’éléments vérifiables (sources, chiffres, dates ou noms). Les affirmations reposent davantage sur la formulation que sur des faits contrôlables.",
        ...
        "explain_hard_fact_good": "Le Hard Fact Score est correct : plusieurs éléments du texte peuvent être vérifiés, même si certaines affirmations restent plus fragiles.",
        ...
        "explain_m_high": "La mécroyance est positive : l’ancrage cognitif domine encore la certitude, ce qui rend le texte plus révisable.",
        ...
        "explain_me_low": "L’indice de mendacity reste faible : le texte semble plutôt relever d’une cognition sincère, même si elle peut rester incomplète.",
        ...
        "explain_d_mid": "La doxa est modérée : le texte affirme avec assurance sans être totalement verrouillé.",
        "explain_d_low": "La doxa est faible : le texte laisse davantage de place à la nuance et à la révision."
    },
    "English": {
        ...
        "cognitive_metrics": "Cognitive Metrics",
        "mecroyance_index": "Mécroyance Index (M)",
        "mendacity_index": "Mendacity Index (ME)",
        "cognitive_gap": "Cognitive gap (M − ME)",
        "dominant_pattern_title": "Dominant cognitive pattern",
    ...
    "Español": {
        ...
        "cognitive_metrics": "Métricas cognitivas",
        "mecroyance_index": "Índice de mécroyance (M)",
        "mendacity_index": "Índice de mentira (ME)",
        "cognitive_gap": "Brecha cognitiva (M − ME)",
        "dominant_pattern_title": "Patrón cognitivo dominante",
    ...
    "Filipino": {
        ...
        "cognitive_metrics": "Mga Metrikang Kognitibo",
        "mecroyance_index": "Indeks ng Mécroyance (M)",
        "mendacity_index": "Indeks ng Pagsisinungaling (ME)",
        "cognitive_gap": "Agwat na Kognitibo (M − ME)",
        "dominant_pattern_title": "Dominanteng padron na kognitibo",
        "dominant_pattern": "Dominanteng padron",
